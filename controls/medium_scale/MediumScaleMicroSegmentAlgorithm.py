...
class MediumScaleMicroSegmentAlgorithm(QgsProcessingAlgorithm):
        ...
        for f in layer.getFeatures():
            ...
            for i in range(len(geom) - 1):
                ...
                if segment.length() < int(taille_mini):
                    micro_segment.append(['ME Géométrie - Micro-segment',
                                          layer.name(),
                                          f.id(),
                                          'geometry',
    ...
    def displayName(self):
        ...
        return "ME Géométrie - Micro-segment"

    def group(self):
        """Nom du groupe"""
        return 'Controles moyenne échelle'
    ...
    def createInstance(self):
        ...
        return MediumScaleMicroSegmentAlgorithm()