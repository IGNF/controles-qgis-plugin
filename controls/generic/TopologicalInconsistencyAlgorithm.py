...
class TopologicalInconsistencyAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        for layer in layers:
            ...
            # Collecte toutes les extrémités connectées
            ...
            for f1 in features:
                ...
                for f2 in features:
                    ...
                    # Vérifie si les extrémités coïncident
            ...
            # Vérifie les extrémités non connectées
            for feature in features:
                ...
                # Vérifie le point de départ s'il n'est pas connecté
                ...
                # Vérifie le point de fin s'il n'est pas connecté
